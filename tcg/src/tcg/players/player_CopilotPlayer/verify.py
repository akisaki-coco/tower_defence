...
def test_imports():
    ...
    try:
        from tcg.players.player_CopilotPlayer.strategy import StrategyEngine
    ...
    try:
        from tcg.players.player_CopilotPlayer.optimizer import ActionOptimizer
    ...
    try:
        from tcg.players.player_CopilotPlayer.tactics import TacticalPatterns
    ...
    try:
        from tcg.players.player_CopilotPlayer.exploits import GameExploits
